...
const (
	...
	InteractiveService_CollectArt_FullMethodName  = "/intr.v1.InteractiveService/CollectArt"
...
type InteractiveServiceClient interface {
	...
	CollectArt(ctx context.Context, in *CollectArtRequest, opts ...grpc.CallOption) (*CollectArtResponse, error)
...
func (c *interactiveServiceClient) CollectArt(ctx context.Context, in *CollectArtRequest, opts ...grpc.CallOption) (*CollectArtResponse, error) {
	out := new(CollectArtResponse)
	err := c.cc.Invoke(ctx, InteractiveService_CollectArt_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InteractiveServiceServer interface {
	...
	CollectArt(context.Context, *CollectArtRequest) (*CollectArtResponse, error)
...
func (UnimplementedInteractiveServiceServer) CollectArt(context.Context, *CollectArtRequest) (*CollectArtResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CollectArt not implemented")
}
...
func _InteractiveService_CollectArt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CollectArtRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InteractiveServiceServer).CollectArt(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InteractiveService_CollectArt_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InteractiveServiceServer).CollectArt(ctx, req.(*CollectArtRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InteractiveService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CollectArt",
			Handler:    _InteractiveService_CollectArt_Handler,
		},
		{
			MethodName: "Get",
