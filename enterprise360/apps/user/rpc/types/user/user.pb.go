...
func (x *RegUserRequest) GetMobile() string {
	if x != nil {
		return x.Mobile
	}
	return ""
...
func (x *RegUserResponse) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_rpc_user_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x57,
	...
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x60, 0x0a, 0x0e, 0x52, 0x65, 0x67, 0x55, 0x73,
	...
	0x64, 0x12, 0x16, 0x0a, 0x06, 0x4d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x4d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x22, 0x21, 0x0a, 0x0f, 0x52, 0x65, 0x67,
	0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02,
	0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x49, 0x64, 0x32, 0x7e, 0x0a, 0x11,
	0x55, 0x73, 0x65, 0x72, 0x43, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x14, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x67, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x67,
...
var file_rpc_user_proto_goTypes = []interface{}{
	...
	(*RegUserRequest)(nil),  // 2: user.RegUserRequest
	(*RegUserResponse)(nil), // 3: user.RegUserResponse
}
var file_rpc_user_proto_depIdxs = []int32{
	0, // 0: user.UserCenterService.Login:input_type -> user.LoginRequest
	2, // 1: user.UserCenterService.Register:input_type -> user.RegUserRequest
	1, // 2: user.UserCenterService.Login:output_type -> user.LoginResponse
	3, // 3: user.UserCenterService.Register:output_type -> user.RegUserResponse
